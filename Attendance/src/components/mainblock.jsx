...
useEffect(() => {
  ...
  fetchStats();
    ...
    const cards=[
        ...
        {name:"Attendance",content:stats.attendance,url:"/attendance"},
        {name:"Late Entries",content:stats.lateEntries,url:"/late entries"},
        {name:"On leave",content:stats.onLeave,url:"/on leave"},
